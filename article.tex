...
%Techniques by
  %tool group (forearm, knife hand, finger etc.)
  %tool (inner forearm, outer forearm, double finger etc.)
...
% what is the groups of techniques?
...
\begin{table}
  ...
  \includegraphics[width=9cm]{all}
  \includegraphics[width=9cm]{motion_type_all}
...
% Is it possible to say anything about why there are more blocks with the
