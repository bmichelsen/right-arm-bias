...
\SubSection{Techniques by Groups}
  ...
  than there are with the right side. There are, therefore, more attacks with
  the right side, than with the left side (Table \ref{tab:table2}, Figure
  \ref{fig:techniques_all}).
