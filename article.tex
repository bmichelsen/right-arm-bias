...
\begin{em}
  ...
  either side.  This is done by attaching metadata, in the form of tags, to
  each pattern movement. These tags are extracted from each movement's English
  description in the Encyclopedia, and supplemented with keywords noted while
  performing the pattern. We then apply concepts from set theory to retrieve
  the information we are interested in, and find that there are seven more
...
\Section{Introduction}
  ...
  the right leg, and 44 \% with the left leg.
