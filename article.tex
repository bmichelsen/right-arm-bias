...
\SubSection{The Data}
  ...
  movements are from Taekwon-Do ITF Sonkal Praha\footnote{\url{http://sonkal.taekwondo.cz}},
  and the English description of each movement is from the condensed
  ...
  The file was reviewed and minor corrections were made to the terminology.
...
% added English movement description from the condensed encyclopedia
% added tags
...
% divided each pattern into its own text file (./patterns/*)
