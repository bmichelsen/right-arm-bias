...
\SubSection{Approach}
  ...
  were registered manually from the condensed encyclopedia. After reviewing
  and making minor corrections to the terminology data, it too was added.
  
  Suitable tags were attached to every movement by first extracting keywords
  from their English description, and second adding more detailed tags while
  ...
  description we are left with:

  \[
    \{left \: walking \: stance, \: low \: block, \: left \: forearm\}
  \]

  Supplementing the above with tags containing more information gives us:
